...
import { ClockIcon, RestartIcon } from './icons/Icons';
...
const LogoHeader: React.FC<LogoHeaderProps> = ({ gameState, timeLeft, resetGame, cardText, player }) => {
  ...
  return (
    <>
      <header 
        className="absolute top-0 left-0 right-0 px-4 sm:px-8 pb-3 flex items-center justify-between w-full z-30 bg-gray-900/50 backdrop-blur-sm border-b border-gray-800/60"
